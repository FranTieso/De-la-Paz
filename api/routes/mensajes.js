...
router.get('/', auth, requireAnyRole("admin", "administrador"), getMensajes);

// GET /api/mensajes/:id - Obtener un mensaje por ID (solo admin)
router.get('/:id', auth, requireAnyRole("admin", "administrador"), getMensajeById);
...
router.put('/:id/leido', auth, requireAnyRole("admin", "administrador"), marcarComoLeido);

// DELETE /api/mensajes/:id - Eliminar un mensaje (solo admin)
router.delete('/:id', auth, requireAnyRole("admin", "administrador"), deleteMensaje);
